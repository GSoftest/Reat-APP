...
class Home extends Component {
               ...
               {childs.map((object, i) => 
                    (object.parent_id === obj.id_menu &&
                      <ListItem obj={object.display_value} key={i} button className={classes.nested}>
                        ...
                        <ListItemText inset primary={object.display_value} onClick = {this.handleClose.bind(this,object.react_component, object.display_value)}/>
                      </ListItem>
      ...
      handleClose = (component,process,event) => {
